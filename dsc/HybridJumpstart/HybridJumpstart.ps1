        ...
        Script "Download CU" {
            ...
            SetScript  = {
                if ($updateImages -eq "Yes") {
                    ...
                    Write-Host -Message "Looking for updates that match: $cuSearchString and $cuID"
        ...
        Script "Download SSU" {
            ...
            SetScript  = {
                if ($updateImages -eq "Yes") {
                    ...
                    Write-Host -Message "Looking for updates that match: $ssuSearchString and $ssuID"
