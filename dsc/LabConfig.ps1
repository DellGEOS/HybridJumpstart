...
$LabConfig = @{ DomainAdminName = 'LabAdmin'; AdminPassword = 'LS1setup!'; DCEdition = '4'; ServerISOFolder = '<<WSServerIsoFolder>>'; `
                ...
                AutoCleanUp = $true; SwitchName = "HybridJumpstartSwitch"; Prefix = "<<VmPrefix>>-";
}
...
1..<<azureStackHCINodes>> | ForEach-Object { 
        $VMNames = "AzSHCI" ; $LABConfig.VMs += @{ VMName = "$VMNames$_" ; Configuration = 'S2D' ; `
                        ...
                        MemoryStartupBytes = <<azureStackHCINodeMemory>>GB; MGMTNICs = 4 ; NestedVirt = $true ; VMProcessorCount = "Max"
        } 
}
