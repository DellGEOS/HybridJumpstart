configuration HybridJumpstart
{
    ...
    Node localhost
    {
        ...
        [String]$azsHCIIsoUri = "https://aka.ms/PVenEREWEEW"
        [String]$labConfigUri = "https://raw.githubusercontent.com/DellGEOS/HybridJumpstart/main/dsc/LabConfigDemo.ps1"
        ...
        if (!((Get-CimInstance win32_systemenclosure).SMBIOSAssetTag -eq "7783-7084-3265-9085-8269-3286-77")) {
            ...
            if (!$AzureStackHCIIsoPath) {
                ...
                $azsHCIISOLocalPath = "$azsHciIsoPath\AzSHCI23H2.iso"
            }
            else {
