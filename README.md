...
In addition to traditional virtualized workloads, more and more organizations are exploring ways to modernize their applications - Kubernetes is an increasingly popular way to do this, yet Kubernetes is complex....unless you're using **Azure Kubernetes Service on Azure Stack HCI**. With AKS-HCI, you really do have the "easy button" to deploy and manage Kubernetes on your infrastructure, and in this jumpstart, you'll see that first hand.
